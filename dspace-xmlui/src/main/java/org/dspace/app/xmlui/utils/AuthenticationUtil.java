...
public class AuthenticationUtil {
     ...
     * @param email The email credentials provided by the user.
     * @param password The password credentials provided by the user.
     * @param realm The realm credentials provided by the user.
     * @return Return a current context with either the eperson attached if the
     * authentication was successful or or no eperson attached if the attempt
     * failed.
     ...
     * the action.
     *
     * @param context The current DSpace context logged in as a site
     * administrator
     * @param request The real HTTP request.
     * @param loginAs Whom to login as.
     ...
     *
     * @param objectModel The Cocoon object model
     * @param email The email of the person to be registered.
     ...
     *
     * @param objectModel The Cocoon object model.
     * @param email The email address of the new eperson.
