...
/**
 * Presents the user (in this case an administrator over the collection) with
 * the form to edit that collection's metadata, logo, and item template.
 *
...
public class EditCollectionMetadataForm extends AbstractDSpaceTransformer {
    ...
    public void addBody(Body body)
        ...
        TextArea short_description = metadataList.addItem().addTextArea("short_description");
        short_description.setValue(collectionService.getMetadata(thisCollection, "short_description"));
        short_description.setSize(6, 40);
