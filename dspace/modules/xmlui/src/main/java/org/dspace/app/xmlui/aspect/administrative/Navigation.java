 ...
 * This includes Epeople, group, item, access control, and registry management.
 *
...
public class Navigation extends AbstractDSpaceTransformer implements CacheableProcessingComponent {
    ...
    private static final Message T_context_create_sub_collection = message("xmlui.administrative.Navigation.context_create_sub_collection");
    ...
    public void addOptions(Options options) throws SAXException, WingException,
        ...
        if (dso instanceof Item) {
            ...
            if (authorizeService.authorizeActionBoolean(this.context, community, Constants.ADD)) {
                context.setHead(T_context_head);
                context.addItemXref(contextPath + "/admin/collection?createNew&communityID=" + community.getID(), T_context_create_sub_collection);
